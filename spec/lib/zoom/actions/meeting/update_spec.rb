...
describe Zoom::Actions::Meeting do
  let(:zc) { zoom_client }
  let(:args) { { meeting_id: 91_538_056_781, topic: 'Updated Topic' } }
  ...
  describe '#meeting_update action' do
    context 'with 204 response' do
      ...
      it "requires a 'meeting_id' argument" do
        ...
        end.to raise_error(Zoom::ParameterMissing, [:meeting_id].to_s)
      end
    ...
    context 'with 404 response' do
      ...
      it 'raises an error' do
        ...
        end.to raise_error(Zoom::Error, { code: 300, message: 'Invalid meeting id.' }.to_s)
      end
    end
  end
